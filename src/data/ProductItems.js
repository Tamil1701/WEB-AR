...
import server_rack from "../assets/models/server_rack.glb";
import server_rack_Usdz from "../assets/models/Server_Rack.usdz";
import server1 from "../assets/models/server.glb";
import server1_Usdz from "../assets/models/Server.usdz";
import mech1 from "../assets/models/light_assault_mech.glb";
import mech1_Usdz from "../assets/models/Light_Assault_Mech.usdz";
import car1 from "../assets/models/bugatti.glb";
import car1_Usdz from "../assets/models/bugatti.usdz";
...
const productItems = [
  ...
  },
  {
    id: 8,
    name: "Server",
    modelSrc: server_rack,
    iOSSrc: server_rack_Usdz,
    category: "Computer",
    color: "Red",
    annotations: [
